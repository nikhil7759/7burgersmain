        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <motion.div variants={linkVariants}>
                <Link className="flex gap-3" to="/menu">
                  <img src="/navbar/menu.svg" />
                  Menu
                </Link>
              </motion.div>
              ...
              <motion.div variants={linkVariants}>
                <Link className="flex gap-3" to="/story">
                  <img src="/navbar/gem.svg" />
                  Our story
                </Link>
              </motion.div>
              <motion.div variants={linkVariants}>
                <Link className="flex gap-3" to="/contact">
                  <img src="/navbar/hedset.svg" />
                  Contact us
                </Link>
              </motion.div>
            </motion.div>
        ...
        animate={{
          ...
          left: `${
            !scrolling
              ...
              : `${
                  windowWidth > 768
                    ? `calc(${0.1 * windowWidth}px)`
                    : `calc(${0.05 * windowWidth}px)`
                }`
          }`,
      ...
      >
        ...
        <div className="md:text-md flex gap-[32px]">
          <motion.div
            animate={{
              x: `${
                !scrolling ? 0 : `${windowWidth > 768 ? "-85%" : "-70% "}`
              }`,
            }}
