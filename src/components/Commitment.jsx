...
const Commitment = () => {
  return (
    <div>
      <div className="w-full bg-[#F4EBDC] px-10 pb-10 sticky flex justify-center items-center">
          ...
          <div className="flex flex-col md:m-6 gap-[24px] w-[70%] md:w-[50%] lg:w-[444px] ">
            ...
            <div className="md:w-[300px] md:h-[140px] lg:w-[427px] lg:h-[140px]">
              <p className="basker">
                ...
                every bite bursts with flavour. Each burger thoughtfully crafted
                ith unique, mouth-watering combination
              </p>
            </div>
