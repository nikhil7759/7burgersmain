...
const Hero = () => {
  return (
    <div className="w-full overflow-x-hidden ">
      <Navbar />
      <div class="flex flex-col md:flex-row bg-[#faad1b] lg:flex-row justify-center items-center md:pt-[55px] lg:pt-[55px] pt-[20px] w-full pb-10 md:h-[667px] lg:h-[667px]">
        <div className="w-full mt-12 ml-10 lg:mt-10 md:w-[60%] lg:w-[40%] flex flex-col lg:p-5 pl-10 box-border ">
          <h1 className=" w-[250px] h-[80px] md:h-[150px] lg:h-[200px] md:w-[300px] lg:w-[480px]">
            <Typewriter text={"Let's get saucy"} delay={100} />
          </h1>
          <br />
          <br />
