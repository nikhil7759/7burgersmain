  ...
  return (
    <div className="relative bg-[#233780] pb-24 rounded-b-[52px] md:rounded-b-[102px] lg:rounded-b-[102px] ">
      <div className="w-full items-center justify-center flex flex-col gap-12">
        <img
          className="w-[300px] h-[200px] md:w-[529px] lg:w-[529px] object-cover our-story-shadow mt-[-40px] z-20 md:h-[339px] lg:h-[339px]  rounded-[52px] border border-black"
          src="/lastSec.jpg"
        />
        <div className="inter font-[800] p-4 text-center text-[24px] text-white">
      ...
      <img
        className="absolute hidden md:block lg:block w-[289px] left-[4%] top-[100px] z-0"
        src="/veg.png"
      />
      <img
        className="absolute hidden md:block lg:block right-[4%] top-[150px] w-[375px] z-0"
        src="/sipper.png"
      />
    </div>
  );
