  ...
  return (
    <div className="relative bg-[#F4EBDC] flex flex-col md:flex-row  p-14">
      <div className=" hidden md:flex lg:flex  justify-center items-center lg:w-[50%] md:w-[50%] ">
        <img
          className="lg:w-[523px]  lg:h-[334px] w-[531px] h-[221px] md:w-[300px] md:h-[221px] object-cover rounded-[52px] border border-black "
      ...
      <div className="md:w-1/3 lg:w-1/3  md:m-auto lg:m-auto m-10  ">
        ...
        <img
          className="mx-auto md:mx-0 lg:mx-0 md:w-[160px] w-[100px] lg:w-[160px] "
          src="/seven.png"
        />
        <p className="mt-4 mb-6 md:text-left lg:text-left text-center   text-[16px] text-[#233780] inter font-[700] basker">
        ...
        <p className="mt-4  md:text-left lg:text-left text-center text-[#233780] text-[16px] inter font-[700] basker">
      ...
      <img
        className="absolute hidden md:block lg:block w-[289px] left-[50%] translate-x-[-50%] bottom-[10%] z-0"
        src="/fries.png"
      />
    </div>
  );
